...
#
# Created: Sat Mar 19 22:09:56 2011
...
class Ui_MainWindowBook(object):
    def setupUi(self, MainWindowBook):
        ...
        self.actionBookOptions.setIcon(icon3)
        self.actionBookOptions.setObjectName("actionBookOptions")
        self.actionBookRemove = QtGui.QAction(MainWindowBook)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/img/img/remove_files.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionBookRemove.setIcon(icon4)
        self.actionBookRemove.setObjectName("actionBookRemove")
        self.actionBookExport = QtGui.QAction(MainWindowBook)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/img/img/export_book.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionBookExport.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/img/img/add_file.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionBookAddFiles.setIcon(icon6)
        self.actionBookAddFiles.setObjectName("actionBookAddFiles")
        self.actionBookAddDirectory = QtGui.QAction(MainWindowBook)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/img/img/add_directory.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionBookAddDirectory.setIcon(icon7)
        self.actionBookAddDirectory.setObjectName("actionBookAddDirectory")
        self.actionBookShiftUp = QtGui.QAction(MainWindowBook)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/img/img/shift_up.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionBookShiftUp.setIcon(icon8)
        self.actionBookShiftUp.setObjectName("actionBookShiftUp")
        self.actionBookShiftDown = QtGui.QAction(MainWindowBook)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/img/img/shift_down.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionBookShiftDown.setIcon(icon9)
        ...
        self.toolBar.addSeparator()
        self.toolBar.addAction(self.actionBookOptions)
